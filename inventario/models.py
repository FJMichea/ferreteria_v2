...
class MovimientoStock(models.Model):
    ...
    motivo = models.CharField(max_length=200, blank=True) # Ej: "Factura 123", "Venta mostrador"
    usuario = models.CharField(max_length=100, default='Sistema') # Quién hizo el movimiento
